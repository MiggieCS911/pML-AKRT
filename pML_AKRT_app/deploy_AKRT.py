...
txt2 = '''The models were trained and tested on data from [SEA-AKI study](https://pubmed.ncbi.nlm.nih.gov/31075172/). This data was provided by Dr. Nattachai Srisawat. All models were externally validated with Vajira Acute Kidney Injury Dataset.
